...
banner:
  ...
  content: "Quality Quantum Cloud Computing"  
...
sections:
  - title: Quality Cloud Quantum Computing
    content: At Quantinent, we're dedicating ourselves to breaking the boundaries of quantum computing - and then handing the reigns to use to utilize these advances.
    image: /images/tired-of-writing.webp

  - title: Not Your Typical Startup
    content: Spearheaded by three of Georgia Tech's best, Quantinent is in no doubt in good hands.
    image: /images/this-is-not-a-library.webp

  - title: Optimized for Consumer Use
    content: High quality user experience is a core tenet at Quantinent.
    image: /images/optimized-out-of-the-box.webp

  - title: The Quantum Future is Imminent
    content: So be ready with Quantinent.
    image: /images/loogs-good.webp


##key features
features:
  title: Why <span class="color:blue">Quantinent</span>?
  description: Because we do things differently than the bureaucratic big tech giants - Quantum computing is a whole new game compared to what the industry is used to.
  feature_list:
